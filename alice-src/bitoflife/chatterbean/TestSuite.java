...
public class TestSuite extends junit.framework.TestSuite {
	 ...
	 * 
	 * @param suite
	 *            The test suite to which the known unit tests must be added.
	 */
	 ...
	 * 
	 * @param args
	 *            The names of test classes that must be included in the test.
	 *            If ommited, all known tests will be included.
	 */
	...
	public static Test suite() {
		...
		if (testNames == null
				|| testNames.length == 0) /*
											 * If no argument was given during
